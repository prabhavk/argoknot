...
public:
    ...
    bool check_reassortment_case_graft_on_same_branch_due_to_zero_muts(map <Node*, vector<string>> reassortment_groups) {
    ...
    void graft_non_reassorment_sample() {
                    ...
                    for (auto group2: reassortment_groups) {
                        if (group1.first->parent == group2.first || group2.first->parent == group1.first) {
                            ...
                            if (group1.first != group2.first) {
                                parent_child = true;
                                cout << "parent-child" << endl;
                                cout << group1.first->name << " " << group2.first->name << endl;
                            }                            
                        }
                    }
                }                
